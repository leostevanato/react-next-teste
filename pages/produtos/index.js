...
export default function Produtos() {
	...
	const [productSaveButtonEnabled, setProductSaveButtonEnabled] = useState(false);
	const urlApiProdutos = process.env.NEXT_PUBLIC_URL + '/api/produtos';
	...
	async function addProduct() {
		...
		setProductSaveButtonEnabled(false);
			...
			<div className={styles.container}>
				<section className={styles.main}>
					...
					<div className={styles.heading}>
						<a href="/api/produtos" target="_blank" rel="noreferrer">
							Database API data
						</a>
					</div>
				</section>
				...
				<section>
					<div className={styles.create}>
						...
						<div className={styles.input}>
							...
							<input
								type="text" ref={productNameRef}
								onChange={event => setProductSaveButtonEnabled(event.target.value.trim().length > 0)}
							/>
						</div>
						...
						<div className={styles.buttonarea}>
							<input
								...
								type="button"
								onClick={addProduct}
								disabled={!productSaveButtonEnabled}
							/>
						</div>
					</div>
				</section>
